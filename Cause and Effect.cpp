...
int main()
{
	...
	while (true) {
		...
		item copper;
		copper.get_cena().text_nazvanie = "copper";
		copper.get_cena().text_kuda_vhodit = "resource";
		copper.set_plus_skolko(1);
		vector_item.push_back(copper);
		item coal;
		coal.get_cena().text_nazvanie = "coal";
		coal.get_cena().text_kuda_vhodit = "resource";
		coal.set_plus_skolko(1);
		vector_item.push_back(coal);
		item steel;
		steel.get_cena().text_nazvanie = "steel";
		steel.get_cena().text_kuda_vhodit = "resource";
		steel.set_plus_skolko(1);

		vector_item.push_back(steel);
		item iron;
		iron.get_cena().text_nazvanie = "iron";
		iron.get_cena().text_kuda_vhodit = "resource";
		iron.set_plus_skolko(1);
		vector_item.push_back(iron);
		item derevo;
		derevo.get_cena().text_nazvanie = "wood";
		derevo.get_cena().text_kuda_vhodit = "resource";
		derevo.set_plus_skolko(1);
		vector_item.push_back(derevo);
		item nickel;
		nickel.get_cena().text_nazvanie = "nickel";
		nickel.get_cena().text_kuda_vhodit = "resource";
		nickel.set_plus_skolko(1);
		vector_item.push_back(nickel);
		item listya;
		listya.get_cena().text_nazvanie = "listya";
		listya.get_cena().text_kuda_vhodit = "resource";
		listya.set_plus_skolko(1);
		vector_item.push_back(listya);
		item bint;
		bint.get_cena().vector_skolko_chego.push_back({3.0,"listya"});
		bint.get_cena().text_nazvanie = "bint";
		bint.get_cena().text_kuda_vhodit = "pribor";
		bint.get_pribor().eto_mozhno_ispolzovat = true;
		bint.get_pribor().k_chemu_ispolzuetsya = "krovotichenie";
		bint.get_pribor().vector_skolko_chego.push_back({-1.0,"kachestvo"});
		vector_item.push_back(bint);
		bool pokozat = 1;

		item organ;
		organ.get_cena().text_nazvanie = "organ";
		organ.get_cena().vector_skolko_chego.push_back({ 0.600,"nickel" });
		organ.get_pribor().k_chemu_ispolzuetsya = "shapka";
		organ.set_plus_skolko(2);
