...
std::string txt51 = " . . . . . вы остановились идти по тропинке в лесу . . . . . 0 попасть в меню. 1 продолжить идти. 2 пойти в пищеру.";
std::string txt551 = " 3 пойти в лес за деревом.";
std::string txt552 = " 4 меню крафта. 44 ничего не делать\n";
std::string txt52 = "\n [===============\n ваше здоровье:  ";
...
std::string txt71 = " ===============]\n";
std::string txt72 = " вы прошли монстров:  ";
...
std::string text_v_lesu = " . . . . . идя в лес вы наткулись на монстра 170, его оружие: ";
