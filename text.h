...
std::string txt_version = " 4.3.12.17(error edition)\n";
...
void russian() {
    ...
    txt6 = " 4 востановить 1 здоровье за 0.31 кг дерева\n";
     ...
     txt9 = " 7 увеличить иммунитет на 15 за 0.040 кг никеля и 0.07 кг железа\n";
     txt10 = " 8 уменьшить инфекцию на 15 за 0.070 кг никеля и 0.1 кг железа\n";
