...
std::string txt_version = " 4.3.14.17(error edition)\n";
...
std::string txt3 = " 1 создать прибор для просмотра значения шапки за 0.6 кг железа (заряд 1)\n";
std::string txt4 = " 2 создать прибор для просмотра значения шарфа за 0.6 кг железа и 0.15 кг дерева (заряд на 1 использование)\n";
...
std::string txt7 = " 5 зарядить 2 раза любой предмет на количество изначального заряда. за 0.3 кг никеля (если при создании у предмета заряд был 1, заряд увеличится на 1, если 10, то на 10. так же вы можете зарядить 2 разных предмета, либо один и тот же)\n";
std::string txt8 = " 6 востановить орган за 0.6 кг никеля\n";
std::string txt08 = " 19 востановить орган2 за 0.2 кг никеля\n";
std::string txt9 = " 7 увеличить иммунитет на 15 за 0.04 кг никеля и 0.07 кг железа\n";
std::string txt10 = " 8 уменьшить инфекцию на 15 за 0.07 кг никеля и 0.1 кг железа\n";
std::string txt11 = " 9 создать деревянного механического кота за 2.5 кг дерева (заряд 10)\n";
std::string txt12 = " 10 создать прибор для повышения значений металла за 2.0 кг дерева (заряд 1)\n";
std::string txt13 = " 11 создать прибор для повышения значений электростанций за 2.0 кг дерева (заряд 1)\n";
std::string txt14 = " 12 создать прибор для просмотра значений металла за 0.8 кг дерева (заряд 1)\n";
std::string txt15 = " 13 создать прибор для просмотра значений электростанций за 0.8 кг дерева (заряд 1)\n";
std::string txt16 = " 14 создать прибор для просмотра значений чая за 1.0 кг дерева (заряд 1)\n";
...
std::string txt111 = "\n - - - - - вы мертвы - - - - -\n\n";
std::string txt112 = " 15 создать копьё за 0.1 кг дерева (прочность 9)\n";
std::string txt113 = " 16 создать факел за 0.4 кг дерева (прочность 9)\n";
std::string txt114 = " 17 создать лук за 0.400 кг дерева (прочность 9)\n";
std::string txt1014 = " 18 создать прибор для уменьшения значения чая за 2.0 кг железа (заряд 1)\n";
std::string txt1015 = " 20 создать бинт за 4 листьев\n";
std::string txt1016 = " 21 создать медную печь за 3.0 кг меди\n";
std::string txt1017 = " 22 создать 0.1 кг угля в медной печи за 0.31 кг дерева\n";
std::string txt1018 = " 23 создать сталь в медной печи за 0.100 кг железа и 0.05 кг угля (топливо дерево или уголь. минимум 0.01 кг)\n";
...
std::string txt1021 = " 24 создать лекарство против болезни за 0.2 кг стали и 1 бинт\n";
...
std::string txt122 = "\n прочность факела: ";
std::string txt123 = "\n прочность лука: ";
std::string txt124 = " никель + 0.02\n\n";
std::string txt125 = " железо + 0.02\n\n";
...
std::string text_v_lesu = " . . . . . (0 выход) идя в лес вы наткулись на монстра 17, его оружие: ";
...
void russian() {
    ...
    txt3 = " 1 создать прибор для просмотра значения шапки за 0.6 кг железа (заряд 1)\n";
    txt4 = " 2 создать прибор для просмотра значения шарфа за 0.6 кг железа и 0.150 кг дерева (заряд на 1 использование)\n";
    ...
    txt6 = " 4 востановить 1 здоровье за 0.31 кг дерева\n";
     txt7 = " 5 зарядить 2 раза любой предмет на количество изначального заряда. за 0.3 кг никеля (если при создании у предмета заряд был 1, заряд увеличится на 1, если 10, то на 10. так же вы можете зарядить 2 разных предмета, либо один и тот же)\n";
     txt8 = " 6 востановить орган за 0.6 кг никеля\n";
     txt08 = " 19 востановить орган2 за 0.2 кг никеля\n";
     txt9 = " 7 увеличить иммунитет на 15 за 0.04 кг никеля и 0.07 кг железа\n";
     txt10 = " 8 уменьшить инфекцию на 15 за 0.07 кг никеля и 0.1 кг железа\n";
     txt11 = " 9 создать деревянного механического кота за 2.5 кг дерева (заряд 10)\n";
     txt12 = " 10 создать прибор для повышения значений металла за 2.0 кг дерева (заряд 1)\n";
     txt13 = " 11 создать прибор для повышения значений электростанций за 2.0 кг дерева (заряд 1)\n";
     txt14 = " 12 создать прибор для просмотра значений металла за 0.8 кг дерева (заряд 1)\n";
     txt15 = " 13 создать прибор для просмотра значений электростанций за 0.8 кг дерева (заряд 1)\n";
     txt16 = " 14 создать прибор для просмотра значений чая за 1.0 кг дерева (заряд 1)\n";
     txt17 = " выберите";
...
txt39 = "ТЭС";
 ...
 txt43 = "кобальт";
     ...
     txt49 = "  . . .\n\n";
     txt50 = "\n 0 попасть в меню. 1 укусить. 2 пройти мимо. 3 поздароваться. 9 меню крафта.";
     txt51 = "\n . . . . . вы остановились идти по тропинке в лесу . . . . .";
  ...
  txt113 = " 16 создать факел за 0.400 кг дерева (прочность 9)\n";
   txt114 = " 17 создать лук за 0.400 кг дерева (прочность 9)\n";
    ...
    txt1016 = " 21 создать медную печь за 3.0 кг меди\n";
     txt1017 = " 22 создать 0.100 кг угля в медной печи за 0.31 кг дерева\n";
     txt1018 = " 23 создать сталь в медной печи за 0.1 кг железа и 0.05 кг угля (топливо дерево или уголь. минимум 0.01 кг)\n";
...
void english() {
    ...
    txt6 = " 4 restore 1 health for 0.31 kg of wood\n";
    ...
    txt8 = " 6 restore the organ for 0.6 kg of nickel\n";
    txt08 = " 19 restore organ2 for 0.2 kg of nickel\n";
    txt9 = " 7 increase immunity by 15 for 0.04 kg of nickel and 0.07 kg of iron\n";
    txt10 = " 8 reduce infection by 15 for 0.07 kg of nickel and 0.1 kg of iron\n";
    txt11 = " 9 craft a wooden mechanical cat for 2.5 kg of wood (10 charges)\n";
    txt12 = " 10 craft a device to increase metal values for 2.0 kg wood (1 charge)\n";
    txt13 = " 11 craft a device to increase power plant values for 2.0 kg wood (1 charge)\n";
    txt14 = " 12 craft a device to view metal values for 0.8 kg wood (1 charge)\n";
    txt15 = " 13 craft a device to view power plant values for 0.8 kg wood (1 charge)\n";
    txt16 = " 14 craft a device to view tea values for 1.0 kg wood (1 charge)\n";
    txt17 = " choose";
    ...
    txt111 = "\n - - - - - you are dead - - - - -\n\n";
    txt112 = " 15 craft a spear for 0.1 wood (durability 9)\n";
    txt113 = " 16 craft a torch for 0.4 wood (durability 9)\n";
    txt114 = " 17 craft a bow for 0.4 wood (durability 9)\n";
