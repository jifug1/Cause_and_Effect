...
std::string txt1017 = " 22 создать 0.100 кг угля в медной печи за 0.150 кг дерева\n";
std::string txt1018 = " 23 создать сталь в медной печи за 0.100 кг железа и 0.050 кг угля (топливо дерево или уголь)\n";
std::string txt1019 = " выберите вид топлива (1 дерево. 2 уголь)\n";
