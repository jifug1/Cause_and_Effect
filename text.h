...
std::string txt1 = " МЕНЮ\n нажмите 1 (затем ENTER) чтобы начать играть. нажмите 2 (затем ENTER) чтобы продолжить игру. нажмите 3 (затем ENTER) чтобы прочитать обучение (без него вы не сможете нормально играть)\n\n\n";
