...
std::string txt12 = " 10 создать прибор для повышения значений металла за 2.0 дерева (заряд 1)\n";
std::string txt13 = " 11 создать прибор для повышения значений электростанций за 2.0 дерева (заряд 1)\n";
...
std::string txt18 = " предмет чей заряд увеличить на 1 ";
...
std::string txt20 = "\n . . . . . ошибка . . . . .\n\n";
std::string txt21 = " 0 выход. перемещение на WASD. E собрать предмет. F боевой режим\n";
std::string txt22 = "\n . . . . . . . . . . началась новая игра! . . . . . . . . . .\n\n";
...
void english() {
    ...
    txt12 = " 10 craft a device to increase metal values for 2.0 wood (1 charge)\n";
    txt13 = " 11 craft a device to increase power plant values for 2.0 wood (1 charge)\n";
    txt14 = " 12 craft a device to view metal values for 0.8 wood (1 charge)\n";
    txt15 = " 13 craft a device to view power plant values for 0.8 wood (1 charge)\n";
    txt16 = " 14 craft a device to view tea values for 1.0 wood (1 charge)\n";
    txt17 = " choose";
    txt18 = " which item to recharge by 1 charge ";
    txt19 = " again";
    ...
    txt20 = "\n . . . . . error . . . . .\n\n";
    txt21 = " 0 exit. Move with WASD. E pick up item. F combat mode\n";
    ...
    txt1014 = " 18 craft a device to decrease tea values for 2.0 kg of iron (1 charge)\n";
    txt115 = " you won\n";
    txt116 = " you lost\n";
